...
<body>
	...
	<?php 
		...
		if (isset($_GET['id'])) {
			...
			$query = "SELECT tb_login_awal.*, tb_resep.* FROM tb_resep 
			INNER JOIN tb_login_awal ON tb_login_awal.kodelogin = tb_resep.kodelogin 
			WHERE tb_resep.id = '$id'";
	...
	<table border="1" style="width: 100%">
		...
		<?php 
			$sql = mysqli_query($koneksi,"select * from tb_resep where id = '$id'");
