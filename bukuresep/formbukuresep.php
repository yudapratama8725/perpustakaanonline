...
<body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="#">Form Buku Resep<span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
	...
	<section>
            <br>
            <h3 align="center">FORM PEMINJAMAN BUKU <font color="#5228ad">RESEP MAKANAN</font></h3>
            <br>
            <div class="container-fluid">
            <table border="1" align="center">
                <class form-control>
                <table border="0" table class="table table-hover table table-bordered table table table-striped">
            <form method="post" action="addresep.php">
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="judulbuku" class="form-control">
     					<option value=""></option>
        				<option value="Makanan Padang">Buku Resep Masakan Padang</option>
        				<option value="Pintar Resep">Buku Pintar Resep</option>
        				<option value="Makanan Indonesia">Buku Resep Masakan Indoensia</option>
        				<option value="Makanan Siap Saji">Buku Resep Makanan Siap Saji</option>
        				<option value="Resep Kue & Roti">Buku Resep Kue & Roti</option>
        				<option value="350 Resep">Buku 350 Resep</option>
        			</select></td>
                </tr>
                <tr>
                 ...
                 <tr>
                    <td colspan="20" align="center">
                        ...
                        <?php if (isset($_GET['id'])) {?>
                            <a href="notaresep.php?id=<?= $_GET['id'] ?>" target="_blank" class="btn btn-outline-secondary">Cetak Nota Laporan</a>
                        <?php } ?>
                    </td>
                </tr>
                   <tr>
