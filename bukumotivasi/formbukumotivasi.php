...
<body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="#">Form Buku Motivasi<span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
	...
	<section>
            <br>
            <h3 align="center">FORM PEMINJAMAN BUKU <font color="#5228ad">MOTIVASI</font></h3>
            <br>
            <div class="container-fluid">
            <table border="1" align="center">
                <class form-control>
                <table border="0" table class="table table-hover table table-bordered table table table-striped">
            <form method="post" action="addmotivasi.php">
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="judulbuku" class="form-control">
     					<option value=""></option>
        				<option value="Mark Manson">Buku Motivasi Mark Manson</option>
        				<option value="Hidup Yang Berarti">Buku Hidup Yang Berarti</option>
        				<option value="Bumi & Langit">Buku Motivasi Bumi & Langit</option>
        				<option value="Brave">Buku Motivasi Brave</option>
        				<option value="Tembus Langit">Buku Tembus Langit</option>
        				<option value="Mantappu Jiwa">Mantappu Jiwa</option>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="20" align="center">
                        ...
                        <?php if (isset($_GET['id'])) {?>
                            <a href="notamotivasi.php?id=<?= $_GET['id'] ?>" target="_blank" class="btn btn-outline-secondary">Cetak Nota Laporan</a>
                        <?php } ?>
                    </td>
                </tr>
                   <tr>
