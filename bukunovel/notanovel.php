...
<body>
	...
	<?php 
		...
		if (isset($_GET['id'])) {
			...
			$query = "SELECT tb_login_awal.*, tb_novel.* FROM tb_novel 
			INNER JOIN tb_login_awal ON tb_login_awal.kodelogin = tb_novel.kodelogin 
			WHERE tb_novel.id = '$id'";
	...
	<table border="1" style="width: 100%">
		...
		<?php 
			$sql = mysqli_query($koneksi,"select * from tb_novel where id = '$id'");
