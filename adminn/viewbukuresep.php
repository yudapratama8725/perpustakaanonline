  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active"><h4>Data Peminjam Buku Resep</h4></li>
        </ol>
       </div>
        <br>
  <section>
      ...
      while ($hasil=mysqli_fetch_array($data)) {
        ...
        <tbody>
          <tr>
            ...
            <td>$hasil[7]</td>
            <td>
              <a href='resep/hapusdataresep.php?id=$hasil[0]'><button>Hapus</button></a>||<a href='resep/formupdateresep.php?id=$hasil[0]'><button>Ubah</button></a>
            </td>
          </tr>
        </tbody>
        ";
