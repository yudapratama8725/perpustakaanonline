...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active"><h4>Data Peminjam Buku Pembelajaran</h4></li>
        </ol>
  ...
  <table align="center" class="content-table" border="1">
    ...
    <?php
      include "koneksi.php";
      $data= mysqli_query($koneksi, "SELECT * FROM tb_pembelajaran");
      while ($hasil=mysqli_fetch_array($data)) {
        ...
        <tbody>
          <tr>
            ...
            <td>$hasil[7]</td>
            <td>
              <a href='pembelajaran/hapusdatapembelajaran.php?id=$hasil[0]'><button>Hapus</button></a>||<a href='pembelajaran/formupdatepembelajaran.php?id=$hasil[0]'><button>Ubah</button></a>
            </td>
          </tr>
        </tbody>
        ";
