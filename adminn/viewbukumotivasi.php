...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active"><h4>Data Peminjam Buku Motivasi</h4></li>
        </ol>
       </div>
        <br>
  <section>
  <table align="center" class="content-table" border="1">
    ...
    <?php
      include "koneksi.php";
      $data= mysqli_query($koneksi, "SELECT * FROM tb_motivasi");
      while ($hasil=mysqli_fetch_array($data)) {
        ...
        <tbody>
          <tr>
            ...
            <td>$hasil[7]</td>
            <td>
              <a href='motivasi/hapusdatamotivasi.php?id=$hasil[0]'><button>Hapus</button></a>||<a href='motivasi/formupdatemotivasi.php?id=$hasil[0]'><button>Ubah</button></a>
            </td>
          </tr>
        </tbody>
        ";
