...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active"><h4>Data User Yang Meminjam BUKU</h4></li>
        </ol>
       </div>
        <br>
  <section>
  <table align="center" class="content-table" border="1">
    ...
    <?php
      include "koneksi.php";
      $data= mysqli_query($koneksi, "SELECT * FROM tb_datauser");
  ...
  <table align="center" class="content-table" border="1">
    ...
    <?php
      include "koneksi.php";
      $data= mysqli_query($koneksi, "SELECT * FROM tb_login_awal");
      while ($hasil=mysqli_fetch_array($data)) {
        echo"
        <tbody>
          <tr>
