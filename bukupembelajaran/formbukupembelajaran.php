...
<body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="#">Form Buku Pembelajaran<span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
	...
	<section>
            <br>
            <h3 align="center">FORM PEMINJAMAN BUKU <font color="#5228ad">PEMBELAJARAN</font></h3>
            <br>
            <div class="container-fluid">
            <table border="1" align="center">
                <class form-control>
                <table border="0" table class="table table-hover table table-bordered table table table-striped">
            <form method="post" action="addpembelajaran.php">
                <tr>
                ...
                <tr>
                    <td colspan="20" align="center">
                        ...
                        <?php if (isset($_GET['id'])) {?>
                            <a href="../nota.php?id=<?= $_GET['id'] ?>" target="_blank" class="btn btn-outline-secondary">Cetak Nota Laporan</a>
                        <?php } ?>
                    </td>
                </tr>
                   <tr>
