...
<body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="#">Form Buku Cerita<span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
	...
	<section>
            <br>
            <h3 align="center">FORM PEMINJAMAN BUKU <font color="#5228ad">CERITA</font></h3>
            <br>
            <div class="container-fluid">
            <table border="1" align="center">
                <class form-control>
                <table border="0" table class="table table-hover table table-bordered table table table-striped">
            <form method="post" action="addcerita.php">
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="judulbuku" class="form-control">
     					<option value=""></option>
        				<option value="Cerita Kancil">Buku Cerita Kancil</option>
        				<option value="Malin Kundang">Buku Cerita Malin Kundang</option>
        				<option value="Timun Mas">Buku Cerita Timun Mas</option>
                        <option value="Cerita Rakyat">Buku Cerita Rakyat</option>
                        <option value="Cerita Dongeng">Buku Cerita Dongeng</option>
                        <option value="Cerita Minuman Nusantara">Buku Cerita Minuman Nusantara</option>
        			</select></td>
                </tr>
                <tr>
                 ...
                 <tr>
                    <td colspan="20" align="center">
                        ...
                        <?php if (isset($_GET['id'])) {?>
                            <a href="notacerita.php?id=<?= $_GET['id'] ?>" target="_blank" class="btn btn-outline-secondary">Cetak Nota Laporan</a>
                        <?php } ?>
                    </td>
                </tr>
                   <tr>
