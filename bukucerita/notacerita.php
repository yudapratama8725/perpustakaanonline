...
<body>
	...
	<?php 
		...
		if (isset($_GET['id'])) {
			...
			$query = "SELECT tb_login_awal.*, tb_cerita.* FROM tb_cerita 
			INNER JOIN tb_login_awal ON tb_login_awal.kodelogin = tb_cerita.kodelogin 
			WHERE tb_cerita.id = '$id'";
	...
	<table border="1" style="width: 100%">
		...
		<?php 
			$sql = mysqli_query($koneksi,"select * from tb_cerita where id = '$id'");
